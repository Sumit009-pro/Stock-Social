...
class ChangeShortAbout extends StatefulWidget {
  const ChangeShortAbout({Key? key}) : super(key: key);

  @override
  _ChangeShortAboutState createState() => _ChangeShortAboutState();
}

class _ChangeShortAboutState extends State<ChangeShortAbout> {
