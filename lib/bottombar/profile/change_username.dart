...
class _ChangeUsernameState extends State<ChangeUsername> {
  ...
  onSubmit() async {
    if (_formKey.currentState!.validate()) {
      ...
      final response = await API.changeUsername(_usernameController.text);
                ...
                child: ListView(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'How do you want to change your username?',
                        style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Please update your new username, ensure that its different from the old one',
                        style: TextStyle(
                          color: Color(0XFF9D9D9D),
                          fontSize: 14,
                          fontWeight: FontWeight.w400,
